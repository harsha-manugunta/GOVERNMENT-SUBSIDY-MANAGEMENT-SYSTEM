...
const consultAnalyst=async (data,type)=>
{
    try{const res=await axios({
        method:'POST',
        url:'/bugSlayers/user/createDeal',
        data
    ...
    document.querySelector('.form--dealer').addEventListener('submit',e=>{
        e.preventDefault();
    ...
    form.append('expectedPrice', document.getElementById('expectedPrice').value);
